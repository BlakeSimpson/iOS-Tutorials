...
{
    //NSString *recipeName = [tableData objectAtIndex:indexPath.row];
    //UIAlertView *messageAlert = [[UIAlertView alloc]
    //                             initWithTitle:@"Row Selected" message:recipeName delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil];
    //[messageAlert show];
